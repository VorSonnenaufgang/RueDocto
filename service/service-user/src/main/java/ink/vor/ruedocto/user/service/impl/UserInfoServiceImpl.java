...
import ink.vor.ruedocto.enums.AuthStatusEnum;
...
import ink.vor.ruedocto.user.service.PatientService;
import ink.vor.ruedocto.user.service.UserInfoService;
import ink.vor.ruedocto.vo.user.LoginVo;
import ink.vor.ruedocto.vo.user.UserAuthVo;
import ink.vor.ruedocto.vo.user.UserInfoQueryVo;
...
public class UserInfoServiceImpl extends ServiceImpl<UserInfoMapper, UserInfo> implements UserInfoService {
    ...
    public Map<String, Object> login(LoginVo loginVo) {
        ...
        if (!code.equals(redisCode)) {
            throw new RueDoctoException(ResultCodeEnum.CODE_ERROR);
        }
        ...
        if (!StringUtils.isEmpty(loginVo.getOpenid())) {
            ...
            if (userInfo != null) {
                ...
                throw new RueDoctoException(ResultCodeEnum.DATA_ERROR);
            }
        }
        ...
        if(userInfo.getStatus() == 0) {
            throw new RueDoctoException(ResultCodeEnum.LOGIN_DISABLED_ERROR);
        }
