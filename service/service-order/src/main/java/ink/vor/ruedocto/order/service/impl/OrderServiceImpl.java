package ink.vor.ruedocto.order.service.impl;
...
import ink.vor.ruedocto.cmn.client.PatientFeignClient;
...
import ink.vor.ruedocto.hosp.client.HospitalFeignClient;
import ink.vor.ruedocto.model.order.OrderInfo;
import ink.vor.ruedocto.model.user.Patient;
import ink.vor.ruedocto.order.mapper.OrderInfoMapper;
...
import ink.vor.ruedocto.vo.order.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderService {
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        if(new DateTime(scheduleOrderVo.getStartTime()).isAfterNow()
            ...
            throw new RueDoctoException(ResultCodeEnum.TIME_NO);
        }
        ...
        if(scheduleOrderVo.getAvailableNumber() <= 0) {
            throw new RueDoctoException(ResultCodeEnum.NUMBER_NO);
        }
        ...
        if(result.getInteger("code") == 200) {
            ...
            throw new RueDoctoException(result.getString("message"), ResultCodeEnum.FAIL.getCode());
        }
